...
class LocalDate extends Date {
	...
	public function Short($localized = true) {
		return $this->Format(Zend_Date::DATE_SHORT, $localized);
	}

	public function Medium($localized = true) {
		return $this->Format(Zend_Date::DATE_MEDIUM, $localized);
	}
